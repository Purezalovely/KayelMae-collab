...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="collapse sidebar-collapse" id="sidebarTogglerDemo02">
    <ul class="sidebar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item <?php echo ($current_page == 'index.php') ? 'active' : ''; ?>">
        <a class="nav-link" href="index.php">List<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item <?php echo ($current_page == 'index.php') ? 'active' : ''; ?>">
        <a class="nav-link" href="Tenantprofile.php">Tenant Profiles<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item <?php echo ($current_page == 'tenant_account.php') ? 'active' : ''; ?>">
        <a class="nav-link" href="tenant_account.php">Tenant Account<span class="sr-only">(current)</span></a>
      </li>
